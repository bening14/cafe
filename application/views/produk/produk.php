            ...
            'columns': [{
                    ...
                    "render": function(data) {
                        return `<div class="d-flex justify-content-start align-items-center product-name">
                                    ...
                                    </div><div class="d-flex flex-column"><h6 class="text-body text-nowrap mb-0">` + data.nama_produk + `</h6>
                                       </div>
                                    </div>`
                    }
                }, {
                ...
                },
                {
                    ...
                    "render": function(data) {
                        return `<div class="d-flex align-items-center">
                                    <a href="javascript:;" class="text-body" onclick="kelola('` + data.id + `')"><i class="ti ti-table-options ti-sm me-2"></i></a>
                                    <a href="javascript:;" class="text-body" onclick="edito('` + data.id + `','` + data.nama_produk + `','` + data.kategori + `','` + data.harga + `')"><i class="ti ti-edit ti-sm me-2"></i></a>
