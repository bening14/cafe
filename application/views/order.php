...
<head>
    ...
    <!-- Favicons Icon -->
	<link rel="shortcut icon" type="image/x-icon" href="<?= base_url('assets/pwa/') ?>assets/images/favicon.png" />
	...
	<!-- Global CSS -->
	<link href="<?= base_url('assets/pwa/') ?>assets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link rel="stylesheet" href="<?= base_url('assets/pwa/') ?>assets/vendor/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css">
	<link rel="stylesheet" href="<?= base_url('assets/pwa/') ?>assets/vendor/nouislider/nouislider.min.css">
	<link rel="stylesheet" href="<?= base_url('assets/pwa/') ?>assets/vendor/swiper/swiper-bundle.min.css">
	
    <!-- Stylesheets -->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/pwa/') ?>assets/css/style.css">
					...
					<ul>
						<li>
							<div class="item-content">
                                ...
                                <div class="item-media media media-90"><img src="<?= base_url('assets/pwa/') ?>assets/images/food/pic1.png" alt="logo">
                        ...
                        <li>
							<div class="item-content">
                                ...
                                <div class="item-media media media-90"><img src="<?= base_url('assets/pwa/') ?>assets/images/food/pic2.png" alt="logo">
                                    <a href="javascript:void(0);" class="item-bookmark icon-2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li>
							<div class="item-content">
                                ...
                                <div class="item-media media media-90"><img src="<?= base_url('assets/pwa/') ?>assets/images/food/pic3.png" alt="logo">
                                    <a href="javascript:void(0);" class="item-bookmark icon-2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M16.785 2.04751C15.9489 2.04694 15.1209 2.21163 14.3486 2.53212C13.5764 2.85261 12.8751 3.32258 12.285 3.91501L12 4.18501L11.73 3.91501C11.1492 3.2681 10.4424 2.74652 9.65306 2.3822C8.86367 2.01787 8.00824 1.81847 7.13912 1.79618C6.27 1.7739 5.40547 1.9292 4.59845 2.25259C3.79143 2.57599 3.05889 3.06066 2.44566 3.67695C1.83243 4.29325 1.35142 5.02819 1.03206 5.83682C0.712696 6.64544 0.561704 7.51073 0.588323 8.37973C0.614942 9.24873 0.818613 10.1032 1.18687 10.8907C1.55513 11.6783 2.08022 12.3824 2.73002 12.96L12 22.2675L21.3075 12.96C22.2015 12.0677 22.8109 10.9304 23.0589 9.6919C23.3068 8.45338 23.1822 7.16915 22.7006 6.00144C22.2191 4.83373 21.4023 3.83492 20.3534 3.13118C19.3045 2.42744 18.0706 2.05034 16.8075 2.04751H16.785Z" fill="white"/>
                                        </svg>
                    ...
                    <ul>
                        <li>
							<div class="item-content">
                                ...
                                <div class="item-media media media-90"><img src="<?= base_url('assets/pwa/') ?>assets/images/food/pic4.png" alt="logo">
                                    <a href="javascript:void(0);" class="item-bookmark icon-2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M16.785 2.04751C15.9489 2.04694 15.1209 2.21163 14.3486 2.53212C13.5764 2.85261 12.8751 3.32258 12.285 3.91501L12 4.18501L11.73 3.91501C11.1492 3.2681 10.4424 2.74652 9.65306 2.3822C8.86367 2.01787 8.00824 1.81847 7.13912 1.79618C6.27 1.7739 5.40547 1.9292 4.59845 2.25259C3.79143 2.57599 3.05889 3.06066 2.44566 3.67695C1.83243 4.29325 1.35142 5.02819 1.03206 5.83682C0.712696 6.64544 0.561704 7.51073 0.588323 8.37973C0.614942 9.24873 0.818613 10.1032 1.18687 10.8907C1.55513 11.6783 2.08022 12.3824 2.73002 12.96L12 22.2675L21.3075 12.96C22.2015 12.0677 22.8109 10.9304 23.0589 9.6919C23.3068 8.45338 23.1822 7.16915 22.7006 6.00144C22.2191 4.83373 21.4023 3.83492 20.3534 3.13118C19.3045 2.42744 18.0706 2.05034 16.8075 2.04751H16.785Z" fill="white"/>
                                        </svg>
                        ...
                        <li>
							<div class="item-content">
                                ...
                                <div class="item-media media media-90"><img src="<?= base_url('assets/pwa/') ?>assets/images/food/pic5.png" alt="logo">
                                    <a href="javascript:void(0);" class="item-bookmark icon-2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M16.785 2.04751C15.9489 2.04694 15.1209 2.21163 14.3486 2.53212C13.5764 2.85261 12.8751 3.32258 12.285 3.91501L12 4.18501L11.73 3.91501C11.1492 3.2681 10.4424 2.74652 9.65306 2.3822C8.86367 2.01787 8.00824 1.81847 7.13912 1.79618C6.27 1.7739 5.40547 1.9292 4.59845 2.25259C3.79143 2.57599 3.05889 3.06066 2.44566 3.67695C1.83243 4.29325 1.35142 5.02819 1.03206 5.83682C0.712696 6.64544 0.561704 7.51073 0.588323 8.37973C0.614942 9.24873 0.818613 10.1032 1.18687 10.8907C1.55513 11.6783 2.08022 12.3824 2.73002 12.96L12 22.2675L21.3075 12.96C22.2015 12.0677 22.8109 10.9304 23.0589 9.6919C23.3068 8.45338 23.1822 7.16915 22.7006 6.00144C22.2191 4.83373 21.4023 3.83492 20.3534 3.13118C19.3045 2.42744 18.0706 2.05034 16.8075 2.04751H16.785Z" fill="white"/>
                                        </svg>
			...
			<div class="item-list style-2">
                <ul>
                    <li>
                        <div class="item-content">
                            <div class="item-media media media-60">
                                <img src="<?= base_url('assets/pwa/') ?>assets/images/food/pic6.png" alt="logo">
                            </div>
                            <div class="item-inner">
                                <div class="item-title-row">
                    ...
                    <li>
                        <div class="item-content">
                            <div class="item-media media media-60">
                                <img src="<?= base_url('assets/pwa/') ?>assets/images/food/food1.png" alt="logo">
                            </div>
                            <div class="item-inner">
                                <div class="item-title-row">
                    ...
                    <li>
                        <div class="item-content">
                            <div class="item-media media media-60">
                                <img src="<?= base_url('assets/pwa/') ?>assets/images/food/pic3.png" alt="logo">
                            </div>
                            <div class="item-inner">
                                <div class="item-title-row">
...
<!--**********************************
    Scripts
***********************************-->
<script src="<?= base_url('assets/pwa/') ?>assets/js/jquery.js"></script>
<script src="<?= base_url('assets/pwa/') ?>assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="<?= base_url('assets/pwa/') ?>assets/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
<script src="<?= base_url('assets/pwa/') ?>assets/vendor/swiper/swiper-bundle.min.js"></script><!-- Swiper -->
<script src="<?= base_url('assets/pwa/') ?>assets/vendor/nouislider/nouislider.min.js"></script>
<script src="<?= base_url('assets/pwa/') ?>assets/js/dz.carousel.js"></script><!-- Swiper -->
<script src="<?= base_url('assets/pwa/') ?>assets/vendor/wnumb/wNumb.js"></script>
<script src="<?= base_url('assets/pwa/') ?>assets/js/noui-slider.init.js"></script>
<script src="<?= base_url('assets/pwa/') ?>assets/vendor/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js"></script><!-- Swiper -->
<script src="<?= base_url('assets/pwa/') ?>assets/js/settings.js"></script><!-- setting.js -->
<script src="<?= base_url('assets/pwa/') ?>assets/js/custom.js"></script>
<script>
    $(".stepper").TouchSpin();
</script>
</body>
