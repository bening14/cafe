...
<body>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-datatable table-responsive">
                                <table id="table-stok-transfer" class="table">
    ...
    <div class="modal fade" id="modaltransferdetail" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header border-bottom">
                    <h5 class="modal-title" id="exampleModalLabel4">Transfer Stok : </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-2">
                        <table id="table-transfer-detail" class="table">
                            <thead class="border-top">
                                <tr>
                                    <th>#</th>
                                    <th>Outlet Asal</th>
...
<script>
    ...
    function terapkanfilter() {
        $("#table-stok-transfer").DataTable({
            ...
            'ajax': {
                'dataType': 'json',
                'url': '<?= base_url() ?>inventory/ajax_table_stok_transfer',
                'type': 'post',
                'data': {
                    outlet: $('#outlet').val(),
            ...
            'columns': [{
                ...
                "target": [<?= $target ?>],
                "className": 'text-center py-1',
                "data": "data.outlet_asal",
            }, {
                "target": [<?= $target ?>],
                "className": 'text-center py-1',
                "data": "data.outlet_tujuan",
            }, {
                "target": [<?= $target ?>],
                "className": 'text-center py-1',
    ...
    $('#btn_download_excel').on('click', function() {
        ...
        $("#btn_download_excel").attr("href", "<?= base_url('inventory/generatedatatransfer') ?>?outlet=" + outlet + "&kategori=" + kategori + "&dari_tanggal=" + dari_tanggal + "&sampai_tanggal=" + sampai_tanggal)
    });
    ...
    function detailtransfer(kode) {
        ...
        $("#table-transfer-detail").DataTable({
            ...
            'ajax': {
                'dataType': 'json',
                'url': '<?= base_url() ?>inventory/ajax_table_transfer_detail',
                'type': 'post',
                'data': {
                    kode: kode
                }
