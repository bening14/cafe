                        ...
                        <div class="col-md-12 col-xl-12 col-xl-12 mb-4">
                            <div class="row">
                                <div class="col-md-12 col-xl-12">
                                    <h4 class="mb-1 mt-3">Manajemen Meja</h4>
                                    <p class="text-muted">Menu dikategorikan sesuai dengan input pada menu Admin</p>
                                </div>
                            </div>
                            <div>
                                <button type="button" class="btn btn-warning waves-effect waves-light"><i class="ti ti-category-2"></i> Semua Meja</button>
                                <button type="button" class="btn btn-secondary waves-effect waves-light"><i class="ti ti-receipt"></i> Transaksi</button>
                                <button type="button" class="btn btn-secondary waves-effect waves-light"><i class="ti ti-history"></i> Riwayat</button>
                            </div>
                        </div>
                        <div class="col-md-12 col-xl-12 col-xl-12 mb-4">
                            <div class="d-flex justify-content-between">
                                <h5>Lantai 1</h5>
                                <button type="button" class="btn btn-sm btn-warning waves-effect waves-light"><i class="ti ti-switch-vertical"></i> Ganti Lantai</button>
                            </div>
                        </div>
                        <!-- Users List Table -->
                        <div class="col-md-12 col-xl-12 col-xl-12 mb-4">
                            <div class="row" id="status_meja">
                                <div class="col-md-3 col-xl-3 mb-3">
                                    <div class="card shadow-none bg-white border border-danger mb-3">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <h4 class="m-0 me-2">Meja 1</h4>
                                                <div><small style="font-size: 16px;">4/4</small> <i class="ti ti-users"></i></div>
                                            </div>
                                        </div>
                                        <div class="card-body pt-4">
                                            <div>00 : 00 : 00</div>
                                            <div class="d-flex justify-content-between">
                                                <h5 class="m-0 me-2 text-danger">Belum Order</h5>
                                ...
                                <div class="col-md-3 col-xl-3 mb-3">
                                    <div class="card shadow-none bg-white border border-info mb-3">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <h4 class="m-0 me-2">Meja 2</h4>
                                                <div><small style="font-size: 16px;">4/4</small> <i class="ti ti-users"></i></div>
                                            </div>
                                        </div>
                                        <div class="card-body pt-4">
                                            <div>00 : 00 : 00</div>
                                            <div class="d-flex justify-content-between">
                                                <h5 class="m-0 me-2 text-info">Tersedia</h5>
                                                <button type="button" class="btn btn-dark waves-effect waves-light"><i class="ti ti-notes"></i>&nbsp;&nbsp;Lihat</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3 col-xl-3 mb-3">
                                    <div class="card shadow-none bg-white border border-success mb-3">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <h4 class="m-0 me-2">Meja 3</h4>
                                                <div><small style="font-size: 16px;">4/4</small> <i class="ti ti-users"></i></div>
                                            </div>
                                        </div>
                                        <div class="card-body pt-4">
                                            <div>00 : 06 : 00</div>
                                            <div class="d-flex justify-content-between">
                                                <h5 class="m-0 me-2 text-success">Sudah Order</h5>
                                                <button type="button" class="btn btn-dark waves-effect waves-light"><i class="ti ti-notes"></i>&nbsp;&nbsp;Lihat</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3 col-xl-3 mb-3">
                                    <div class="card shadow-none bg-secondary border border-dark mb-3">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <h4 class="m-0 me-2">Meja 4</h4>
                                                <div><small style="font-size: 16px;">0/4</small> <i class="ti ti-users"></i></div>
                                            </div>
                                        </div>
                                        <div class="card-body pt-4">
                                            <div>00 : 00 : 00</div>
                                            <div class="d-flex justify-content-between">
                                                <h5 class="m-0 me-2 text-dark">Tidak Tersedia</h5>
                                                <button type="button" class="btn btn-dark waves-effect waves-light"><i class="ti ti-notes"></i>&nbsp;&nbsp;Lihat</button>
                                            </div>
                                        </div>
                                    </div>
