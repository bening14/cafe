...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= base_url('assets/template-admin/') ?>assets/vendor/css/pages/page-misc.css" />
...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <div class="mt-4">
                <img src="<?= base_url('assets/template-admin/') ?>assets/img/illustrations/page-misc-error.png" alt="page-misc-error" width="225" class="img-fluid" />
            </div>
        </div>
    </div>
    <div class="container-fluid misc-bg-wrapper">
        <img src="<?= base_url('assets/template-admin/') ?>assets/img/illustrations/bg-shape-image-light.png" alt="page-misc-error" data-app-light-img="illustrations/bg-shape-image-light.png" data-app-dark-img="illustrations/bg-shape-image-dark.png" />
    </div>
    <!-- /Error -->
