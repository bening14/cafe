...
<html
  ...
  data-assets-path="<?= base_url('assets/template-admin/') ?>assets/"
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="../horizontal-menu-template" class="menu-link" target="_blank">
                    <div data-i18n="Horizontal">Horizontaal</div>
                  </a>
                </li>
                <li class="menu-item">
                      ...
                      <ul class="list-group list-group-flush">
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="<?= base_url('assets/template-admin/') ?>assets/img/avatars/1.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="<?= base_url('assets/template-admin/') ?>assets/img/avatars/2.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="<?= base_url('assets/template-admin/') ?>assets/img/avatars/9.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="<?= base_url('assets/template-admin/') ?>assets/img/avatars/5.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="<?= base_url('assets/template-admin/') ?>assets/img/avatars/6.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row mb-5">
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card h-100">
                    <img class="card-img-top" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/2.jpg" alt="Card image cap" />
                    <div class="card-body">
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card h-100">
                    ...
                    <img class="img-fluid" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/10.jpg" alt="Card image cap" />
                    <div class="card-body">
                  ...
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      <img
                        ...
                        src="<?= base_url('assets/template-admin/') ?>assets/img/elements/4.jpg"
                        alt="Card image cap" />
                      <p class="card-text">Bear claw sesame snaps gummies chocolate.</p>
                      <a href="javascript:void(0);" class="card-link">Card link</a>
                      <a href="javascript:void(0);" class="card-link">Another link</a>
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-6 col-lg-4">
                  ...
                  <div class="card mb-4">
                    <img class="card-img-top" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/5.jpg" alt="Card image cap" />
                    <div class="card-body">
                      <p class="card-text">
                        Some quick example text to build on the card title and make up the bulk of the card's content.
                      </p>
                ...
                <div class="col-md-6 col-lg-4">
                  ...
                  <div class="card">
                    <img class="card-img-top" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/7.jpg" alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-6 col-xl-4">
                  <div class="card mb-3">
                    ...
                    <img class="card-img-bottom" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/1.jpg" alt="Card image cap" />
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-dark border-0 text-white">
                    <img class="card-img" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/8.jpg" alt="Card image" />
              ...
              <!-- Horizontal -->
              <h5 class="pb-1 mb-4">Horizontaal</h5>
              <div class="row mb-5">
                <div class="col-md">
                  <div class="card mb-3">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img class="card-img card-img-left" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/9.jpg" alt="Card image" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title">Card title</h5>
                ...
                <div class="col-md">
                  <div class="card mb-3">
                    <div class="row g-0">
                      ...
                      <div class="col-md-4">
                        <img class="card-img card-img-right" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/12.jpg" alt="Card image" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-group mb-5">
                <div class="card">
                  <img class="card-img-top" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/4.jpg" alt="Card image cap" />
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">
                      This is a wider card with supporting text below as a natural lead-in to additional content. This
                ...
                <div class="card">
                  <img class="card-img-top" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/1.jpg" alt="Card image cap" />
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">
                      This is a wider card with supporting text below as a natural lead-in to additional content. This
              ...
              <div class="row row-cols-1 row-cols-md-3 g-4 mb-5">
                ...
                <div class="col">
                  <div class="card h-100">
                    <img class="card-img-top" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/10.jpg" alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">
                        This is a longer card with supporting text below as a natural lead-in to additional content.
                ...
                <div class="col">
                  <div class="card h-100">
                    <img class="card-img-top" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/13.jpg" alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">
                        This is a longer card with supporting text below as a natural lead-in to additional content.
                ...
                <div class="col">
                  <div class="card h-100">
                    <img class="card-img-top" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/14.jpg" alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">
                        This is a longer card with supporting text below as a natural lead-in to additional content.
                ...
                <div class="col">
                  <div class="card h-100">
                    <img class="card-img-top" src="<?= base_url('assets/template-admin/') ?>assets/img/elements/15.jpg" alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">
                        This is a longer card with supporting text below as a natural lead-in to additional content.
