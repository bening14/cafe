                            ...
                            <div class="card-header border-bottom" style="text-align: right;">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-sm btn-info" onclick="tambaho()"><i class="ti ti-users"></i> Tambah</button>
                                    </div>
                                </div>
                            </div>
                            <div class="card-datatable table-responsive">
                                <table id="table-supplier" class="table">
                ...
                <div class="modal-body">
                    ...
                    <form id="form-data" class="row g-3">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="nama_supplier" name="nama_supplier" class="form-control" placeholder="Misal : PT. ABC" />
                        </div>
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="telephone">Telephone</label>
                            <input type="text" id="telephone" name="telephone" class="form-control" placeholder="Misal : 021-786756" />
                        </div>
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="email">Email</label>
                            <input type="text" id="email" name="email" class="form-control" placeholder="Misal : andi@abc.co.id" />
                        </div>
                        <div class="col-12 col-md-12">
            ...
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <form id="form-data-edit" class="row g-3">
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="nama_supplier_e">Nama Supplier</label>
                            <input type="text" id="nama_supplier_e" name="nama_supplier_e" class="form-control" placeholder="Misal : PT. ABC" />
                            <input type="hidden" id="id_e" name="id_e" class="form-control" />
                        </div>
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="telephone_e">Telephone</label>
                            <input type="text" id="telephone_e" name="telephone_e" class="form-control" placeholder="Misal : 021-908978" />
                        </div>
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="email_e">Email</label>
                            <input type="text" id="email_e" name="email_e" class="form-control" placeholder="Misal : andi@abc.co.id" />
                        </div>
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="alamat_e">Alamat</label>
                            <textarea name="alamat_e" id="alamat_e" cols="30" rows="5" class="form-control"></textarea>
                        </div>
...
<script>
    ...
    $(function() {
        $("#table-supplier").DataTable({
            ...
            'ajax': {
                'dataType': 'json',
                'url': '<?= base_url() ?>belanja/ajax_table_supplier',
                'type': 'post',
                'data': {
                ...
                },
                {
                    ...
                    "render": function(data) {
                        return `<div class="d-flex align-items-center">
                                    <a href="javascript:;" class="text-body" onclick="edito('` + data.id + `','` + data.nama_supplier + `','` + data.alamat + `','` + data.telephone + `','` + data.email + `')"><i class="ti ti-edit ti-sm me-2"></i></a>
    ...
    $("#form-data").submit(function(e) {
        ...
        if ($('#nama_supplier').val() == '' || $('#alamat').val() == '' || $('#telephone').val() == '' || $('#email').val() == '') {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
        ...
        form_data.append('table', 'mst_supplier');
        ...
        var url_ajax = '<?= base_url() ?>belanja/insert_data_supplier'
    ...
    function edito(id, nama, alamat, telephone, email) {
        $('#editsupplier').modal('show')

        $('#id_e').val(id)
        $('#nama_supplier_e').val(nama)
        $('#alamat_e').val(alamat)
    ...
    $("#form-data-edit").submit(function(e) {
        ...
        if ($('#nama_supplier_e').val() == '' || $('#telephone_e').val() == '' || $('#email_e').val() == '' || $('#alamat_e').val() == '') {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Tidak boleh ada kolom kosong!',
        ...
        var form_data = new FormData();
        form_data.append('table', 'mst_supplier');
        form_data.append('nama_supplier', $("#nama_supplier_e").val());
