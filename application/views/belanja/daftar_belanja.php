...
<body>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            ...
                            <div class="card-datatable table-responsive">
                                <table id="table-belanja" class="table">
    ...
    <div class="modal fade" id="tambahbelanja" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <form id="form-data" method="post" class="row g-3">
                        ...
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="nama_produk" name="nama_produk" class="form-control" placeholder="Misal : Teh Botol" />
                        </div>
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="brand">Brand</label>
                            <input type="text" id="brand" name="brand" class="form-control" placeholder="Misal : Sosro" />
                        </div>
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="supplier">Supplier</label>
                            <input type="text" id="supplier" name="supplier" class="form-control" placeholder="Misal : PT. ABCD" />
                        </div>
                        <div class="col-12 col-md-12">
...
<script>
    ...
    $(function() {
        $("#table-belanja").DataTable({
            ...
            'ajax': {
                'dataType': 'json',
                'url': '<?= base_url() ?>belanja/ajax_table_belanja',
                'type': 'post',
                'data': {
    ...
    function reload_table() {
        $('#table-belanja').DataTable().ajax.reload(null, false);
    }


    function tambaho() {
        $('#tambahbelanja').modal('show')
    }
    ...
    $("#form-data").submit(function(e) {
        ...
        if ($('#nama_produk').val() == '' || $('#brand').val() == '' || $('#supplier').val() == '' || $('#jumlah').val() == '' || $('#satuan').val() == '' || $('#harga_satuan').val() == '') {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
        ...
        form_data.append('table', 'tbl_daftar_belanja');
        ...
        form_data.append('harga_satuan', $("#harga_satuan").val());
        form_data.append('id_mst_bisnis', '<?= $id_mst_bisnis ?>');

        var url_ajax = '<?= base_url() ?>belanja/insert_data_belanja'
